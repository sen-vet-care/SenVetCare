      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
        ...
        <div className="lg:col-span-5 flex flex-col gap-8">
            <div className="grid grid-cols-1 gap-6">
                {/* Phone */}
                <div className="group p-6 rounded-3xl bg-white border border-outline-variant/30 shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden">
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <a href="tel:+919876543210" className="font-manrope font-bold text-2xl text-primary hover:text-primary-container transition-colors">+91 98711 55162</a>
                        </div>
                    </div>
                </div>
                ...
                <div className="group p-6 rounded-3xl bg-white border border-outline-variant/30 shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden">
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <a href="https://wa.me/919871155162" className="inline-flex font-inter font-bold text-[12px] tracking-widest uppercase bg-pharmacy-green text-on-primary px-4 py-2 rounded-md hover:bg-opacity-90 transition-colors items-center gap-2">
                                Message Us Now
        ...
        <div className="lg:col-span-7 flex flex-col gap-8">
            <div className="p-8 rounded-3xl bg-white/60 backdrop-blur-md border border-white/40 shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative overflow-hidden">
                <h2 className="font-manrope font-bold text-[32px] text-ink-depth mb-2 relative z-10">Send a Message</h2>
                <p className="font-inter text-[16px] text-on-surface-variant mb-8 relative z-10">Fill out the form below and our reception team will get back to you shortly.</p>
                ...
                <form className="space-y-6 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="firstName" placeholder="John" className="w-full bg-white border border-outline-variant/50 rounded-2xl px-4 py-3 font-inter text-[16px] text-ink-depth focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all outline-none" />
                        </div>
                        <div>
                            ...
                            <input type="text" id="lastName" placeholder="Doe" className="w-full bg-white border border-outline-variant/50 rounded-2xl px-4 py-3 font-inter text-[16px] text-ink-depth focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all outline-none" />
                        </div>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="email" id="email" placeholder="john@example.com" className="w-full bg-white border border-outline-variant/50 rounded-2xl px-4 py-3 font-inter text-[16px] text-ink-depth focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all outline-none" />
                        </div>
                        <div>
                            ...
                            <input type="tel" id="phone" placeholder="+91 00000 00000" className="w-full bg-white border border-outline-variant/50 rounded-2xl px-4 py-3 font-inter text-[16px] text-ink-depth focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all outline-none" />
                        </div>
                    </div>
                    <div>
                        ...
                        <textarea id="message" rows={4} placeholder="How can we help you today?" className="w-full bg-white border border-outline-variant/50 rounded-2xl px-4 py-3 font-inter text-[16px] text-ink-depth focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all outline-none resize-none"></textarea>
                    </div>
                    <button type="submit" className="w-full bg-primary text-on-primary font-manrope font-semibold text-[18px] py-4 rounded-full hover:bg-primary-container transition-colors shadow-sm flex items-center justify-center gap-2 group">
                        Submit Inquiry
