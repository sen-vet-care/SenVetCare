    ...
    <div className="min-h-screen bg-black/5 text-on-background pb-20">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 mt-10 grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-3 space-y-2">
          <button className="w-full text-left px-5 py-4 bg-emerald-50 text-primary border border-emerald-100 rounded-2xl font-inter font-bold text-sm flex items-center gap-4 transition-colors">
            <span className="material-symbols-outlined">dashboard</span>
            Overview
          </button>
          
          {userRole === 'pet-owner' && (
            <button className="w-full text-left px-5 py-4 text-on-surface-variant hover:bg-surface-container-low hover:text-ink-depth rounded-2xl font-inter font-medium text-sm flex items-center gap-4 transition-colors">
          ...
          <button className="w-full text-left px-5 py-4 text-on-surface-variant hover:bg-surface-container-low hover:text-ink-depth rounded-2xl font-inter font-medium text-sm flex items-center gap-4 transition-colors mt-8">
