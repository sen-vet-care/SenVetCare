      ...
      >
        ...
        <div className="mt-auto pt-12 border-t border-zinc-200">
            <div className="flex gap-4 justify-center mb-6">
                <a href="tel:09871155162" target="_blank" rel="noopener noreferrer" className="bg-emerald-800 text-white px-6 py-2 rounded-lg text-sm font-bold hover:bg-emerald-700 transition">Call Now</a>
                <a href="https://wa.me/919871155162" target="_blank" rel="noopener noreferrer" className="bg-emerald-600 text-white px-6 py-2 rounded-lg text-sm font-bold hover:bg-emerald-500 transition">WhatsApp</a>
                <a href="/booking" target="_blank" rel="noopener noreferrer" className="bg-emerald-800 text-white px-6 py-2 rounded-lg text-sm font-bold hover:bg-emerald-700 transition">Book Visit</a>
            </div>
